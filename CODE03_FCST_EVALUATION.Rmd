...
listBigCombDensAve = apply( fcstTime, 1, function(t){ # t = c( 2009, 1 )
    ...
    list( x = list_dens[[1]]$x, y = dens_comb_ave )
    ...
    # lines( list_dens[[1]]$x, dens_comb_ave, col = 2, lwd = 2 )

})

i = 107

plot( NA, xlim = range( listBigCombDensAve[[i]]$x ), ylim = range( listBigCombDensAve[[i]]$y ) )

...
```{r }
path_data_m = "z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\DATA\\CCM\\RTX\\"
...
spath_ar2_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\UNI-AR2_PRB\\SV-OFF\\'
spath_ar0_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\UNI-AR0_PRB\\SV-OFF\\'
spath_lrg_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\LRG-ALL_PRB\\SV-OFF\\'
spath_sml_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SML-ALL_PRB\\SV-OFF\\'


spath_sim_ism_off    <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-ISM_PRB\\SV-OFF\\'
spath_sim_employ_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-EMPLOY_PRB\\SV-OFF\\'
spath_sim_supdel_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-SUPDEL_PRB\\SV-OFF\\'
spath_sim_orders_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-ORDERS_PRB\\SV-OFF\\'
spath_sim_hours_off  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-HOURS_PRB\\SV-OFF\\'
spath_sim_sp500_off  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-SP500_PRB\\SV-OFF\\'
spath_sim_tbill_off  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-TBILL_PRB\\SV-OFF\\'
spath_sim_tbond_off  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-TBOND_PRB\\SV-OFF\\'
spath_sim_claims_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-CLAIMS_PRB\\SV-OFF\\'
spath_sim_rsales_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-RSALES_PRB\\SV-OFF\\'
spath_sim_ip_off     <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-IP_PRB\\SV-OFF\\'
spath_sim_starts_off <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-STARTS_PRB\\SV-OFF\\'


spath_ar2_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\UNI-AR2_PRB\\SV-ON\\'
spath_ar0_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\UNI-AR0_PRB\\SV-ON\\'
spath_lrg_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\LRG-ALL_PRB\\SV-ON\\'
spath_sml_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SML-ALL_PRB\\SV-ON\\'


spath_sim_ism_on    <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-ISM_PRB\\SV-ON\\'
spath_sim_employ_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-EMPLOY_PRB\\SV-ON\\'
spath_sim_supdel_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-SUPDEL_PRB\\SV-ON\\'
spath_sim_orders_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-ORDERS_PRB\\SV-ON\\'
spath_sim_hours_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-HOURS_PRB\\SV-ON\\'
spath_sim_sp500_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-SP500_PRB\\SV-ON\\'
spath_sim_tbill_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-TBILL_PRB\\SV-ON\\'
spath_sim_tbond_on  <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-TBOND_PRB\\SV-ON\\'
spath_sim_claims_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-CLAIMS_PRB\\SV-ON\\'
spath_sim_rsales_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-RSALES_PRB\\SV-ON\\'
spath_sim_ip_on     <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-IP_PRB\\SV-ON\\'
spath_sim_starts_on <- 'Z:\\NotesKOF\\PAPERS\\US-CCM-DATA-ACTL\\RESU\\CCM\\SIM-STARTS_PRB\\SV-ON\\'
